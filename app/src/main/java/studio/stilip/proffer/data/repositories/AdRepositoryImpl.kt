...
class AdRepositoryImpl @Inject constructor() : AdRepository {
    ...
    val ads = mutableListOf(
        AdEntityForApi( 1, "", "Кружка", 100,"88007000628","Большая и с картинкой", "Металлическая", true,"Екатеринбург, Толмачева 9", listOf(),3),
        AdEntityForApi(2, "", "Шины", 30000, "88007000628","Зимние", "Нагрузка до 100 кг", true,"Екатеринбург, Толмачева 9", listOf("Шины, диски и колёса","Для автомобиля"),1),
        AdEntityForApi(3, "", "Мотор", 90000,"88007000628", "Бензиновый мотор четвертого поколения", "15 л.с.",true, "Екатеринбург, Толмачева 9", listOf("Запчасти","Для автомобиля"),2),
        AdEntityForApi(4, "", "Облако", 3400, "88007000628","Белое и воздушное", "100 х 200",false, "Екатеринбург, Толмачева 9",listOf(), 1),
        AdEntityForApi(5, "", "Укроп", 1100,"88007000628", "Свежий и душистый", "10 кг.",true, "Екатеринбург, Толмачева 9",listOf(), 3),
        AdEntityForApi(6, "", "Тарелка", 190,"88007000628", "Использованная и одноразовая", "Пластик", true,"Екатеринбург, Толмачева 9", listOf(),2),
    )

    val complAds = mutableListOf(
        AdEntityForApi( 1, "", "Свеча", 1000,"88007000628","Новая, на запчасти", "Металлическая", true,"Екатеринбург, Толмачева 9", listOf(),1),
        AdEntityForApi(2, "", "Шины Bridgestone", 20000, "88007000628","Летние", "Нагрузка до 100 кг", true,"Екатеринбург, Толмачева 9", listOf(),1),
    )
