...
class AdRepositoryImpl @Inject constructor() : AdRepository {
    ...
    val ads = mutableListOf(
        AdEntityForApi( 1, "", "Кружка", 100,"Большая и с картинкой", "Металлическая", "Екатеринбург, Толмачева 9", listOf(),3),
        AdEntityForApi(2, "", "Шины", 30000, "Зимние", "Нагрузка до 100 кг", "Екатеринбург, Толмачева 9", listOf("Шины, диски и колёса","Для автомобиля"),1),
        AdEntityForApi(3, "", "Мотор", 90000, "Бензиновый мотор четвертого поколения", "15 л.с.", "Екатеринбург, Толмачева 9", listOf("Запчасти","Для автомобиля"),2),
        AdEntityForApi(4, "", "Облако", 3400, "Белое и воздушное", "100 х 200", "Екатеринбург, Толмачева 9",listOf(), 1),
        AdEntityForApi(5, "", "Укроп", 1100, "Свежий и душистый", "10 кг.", "Екатеринбург, Толмачева 9",listOf(), 3),
        AdEntityForApi(6, "", "Тарелка", 190, "Использованная и одноразовая", "Пластик", "Екатеринбург, Толмачева 9", listOf(),2),
    )
